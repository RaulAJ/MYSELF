...
INTRODUCCIÓN
Este documento especifica un diseño para nuestro proyecto de videojuego llamado "Myself", que será creado en el segundo cuatrimestre del curso 2023-2024. En este proyecto están involucrados Raúl Arellano Jorge, Mario Alcolea Alcolea, Jorge López Carrión y Unai.
...
Control:
Se podrá jugar tanto por teclado y ratón como por mando.
Los controles serán:
