...
export default class Level extends Phaser.Scene {
    ...
    create() {
        ...
        this.zone1Change1 = this.add.zone(9600,1680,50,300);
        this.zone2Change1 = this.add.zone(9600, 1680,100,300);
        this.zone3Change1 = this.add.zone(10650, 2144,100,300);
        this.zone3Change2 = this.add.zone(9365,5723,100,300);
        this.zone2Change2 = this.add.zone(13460, 4603,100,300);
        this.zone1Change2 = this.add.zone(9235,5723,50,30);
        this.zone4Change = this.add.zone(15070,5723,100,300);
    ...
    isPlayerMoving() {
        // Devuelve true si el jugador se está moviendo (si tiene alguna velocidad)
        return this.player.body.velocity.x !== 0 || this.player.body.velocity.y !== 0;
    }
